...
public final class AMultiplicacaoExpressaoAritmetica extends PExpressaoAritmetica
{
    private PExpressaoAritmetica _esquerda_;
    private PExpressaoAritmetica _direita_;

    public AMultiplicacaoExpressaoAritmetica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultiplicacaoExpressaoAritmetica(
    ...
    {
        ((Analysis) sw).caseAMultiplicacaoExpressaoAritmetica(this);
    }
