...
public final class AMenorQExpressaoLogica extends PExpressaoLogica
{
    private PExpressaoAritmetica _esquerda_;
    private PExpressaoAritmetica _direita_;

    public AMenorQExpressaoLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorQExpressaoLogica(
    ...
    {
        ((Analysis) sw).caseAMenorQExpressaoLogica(this);
    }
