...
public final class ADivisaoExpressaoAritmetica extends PExpressaoAritmetica
{
    private PExpressaoAritmetica _esquerda_;
    private PExpressaoAritmetica _direita_;

    public ADivisaoExpressaoAritmetica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADivisaoExpressaoAritmetica(
    ...
    {
        ((Analysis) sw).caseADivisaoExpressaoAritmetica(this);
    }
