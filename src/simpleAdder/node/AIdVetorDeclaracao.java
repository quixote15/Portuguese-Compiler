...
public final class AIdVetorDeclaracao extends PDeclaracao
{
    private TId _id_;
    private TNumInt _numInt_;

    public AIdVetorDeclaracao()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAIdVetorDeclaracao(this);
    }
